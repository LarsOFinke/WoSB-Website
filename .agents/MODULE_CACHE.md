...
| `spring-api/src/main/java/eu/royalblackwater/api/warehouse/` | fleet-scoped guild stock and reservations | holder membership, row version, audit event |
...
| `frontend/src/modules/warehouse/` | admin guild-stock workspace | domain validation, composable state, conflict handling |

export const systemOperationsMessages = {
  en: {
    admin: {
      system: {
        ...
        operations: { update: 'Standard update', update_migrate_seed: 'Update + migrations + seed' },
  ...
  de: {
    admin: {
      system: {
        ...
        operations: { update: 'Standard-Update', update_migrate_seed: 'Update + Migrationen + Seed' },
  ...
  es: {
    admin: {
      system: {
        monitoringTitle: 'Monitorización Uptime', monitoringText: 'Abre Uptime Kuma mediante la pasarela HTTPS dedicada. El puerto 8443 solo acepta HTTPS.', openMonitoring: 'Abrir Uptime Kuma', httpsHint: 'Usa siempre https:// en el puerto 8443.', updateTitle: 'Actualización del servidor', updateText: 'Descarga la última versión fast-forward, crea una copia, reconstruye la aplicación, ejecuta migraciones y verifica el servicio.', updateButton: 'Actualizar servidor', migrateSeedButton: 'Actualizar + migrar + seed', migrateSeedConfirm: 'Se creará una copia de seguridad de la base de datos y después se ejecutarán todas las migraciones y el seed idempotente. ¿Continuar?', updateRunning: 'Actualización en curso ...', refresh: 'Actualizar estado', statusLabel: 'Estado de actualización', operation: 'Operación', requestedBy: 'Solicitado por', startedAt: 'Iniciado', finishedAt: 'Finalizado', commit: 'Revisión', requestAccepted: 'El runner del host aceptó la solicitud.', migrateSeedRequestAccepted: 'El runner del host aceptó la actualización con migraciones y seed.', requestError: 'No se pudo solicitar la actualización.', loadError: 'No se pudo cargar el estado.', logTitle: 'Registro de actualización', logEmpty: 'Todavía no hay registro de actualización.', adminOnly: 'Solo los administradores pueden iniciar una actualización.', operations: { update: 'Actualización estándar', update_migrate_seed: 'Actualización + migraciones + seed' }, states: { idle: 'Inactivo', queued: 'En cola', running: 'En curso', succeeded: 'Correcto', failed: 'Fallido' },
  ...
  ru: {
    admin: {
      system: {
        monitoringTitle: 'Мониторинг Uptime', monitoringText: 'Откройте Uptime Kuma через отдельный HTTPS-шлюз. Порт 8443 принимает только HTTPS.', openMonitoring: 'Открыть Uptime Kuma', httpsHint: 'На порту 8443 всегда используйте https://.', updateTitle: 'Обновление сервера', updateText: 'Получает последнюю fast-forward версию, создает резервную копию, пересобирает приложение, выполняет миграции и проверяет готовность.', updateButton: 'Обновить сервер', migrateSeedButton: 'Обновить + миграции + seed', migrateSeedConfirm: 'Будет создана резервная копия базы данных, затем выполнены все миграции и идемпотентный seed. Продолжить?', updateRunning: 'Обновление выполняется ...', refresh: 'Обновить статус', statusLabel: 'Статус обновления', operation: 'Операция', requestedBy: 'Запросил', startedAt: 'Начато', finishedAt: 'Завершено', commit: 'Ревизия', requestAccepted: 'Host runner принял запрос.', migrateSeedRequestAccepted: 'Host runner принял обновление с миграциями и seed.', requestError: 'Не удалось запросить обновление.', loadError: 'Не удалось загрузить статус.', logTitle: 'Журнал обновления', logEmpty: 'Журнал обновления пока отсутствует.', adminOnly: 'Только администраторы могут запускать обновление.', operations: { update: 'Обычное обновление', update_migrate_seed: 'Обновление + миграции + seed' }, states: { idle: 'Ожидание', queued: 'В очереди', running: 'Выполняется', succeeded: 'Успешно', failed: 'Ошибка' },
  ...
  cn: {
    admin: {
      system: {
        monitoringTitle: 'Uptime 监控', monitoringText: '通过独立的 HTTPS 网关打开 Uptime Kuma。8443 端口仅接受 HTTPS。', openMonitoring: '打开 Uptime Kuma', httpsHint: '8443 端口必须使用 https://。', updateTitle: '服务器更新', updateText: '获取最新的 fast-forward 版本，创建备份，重新构建应用，执行迁移并检查服务状态。', updateButton: '更新服务器', migrateSeedButton: '更新 + 迁移 + 种子', migrateSeedConfirm: '这将创建数据库备份，然后执行所有迁移和幂等种子。是否继续？', updateRunning: '正在更新 ...', refresh: '刷新状态', statusLabel: '更新状态', operation: '操作', requestedBy: '请求者', startedAt: '开始时间', finishedAt: '完成时间', commit: '版本', requestAccepted: '主机更新执行器已接受请求。', migrateSeedRequestAccepted: '主机更新执行器已接受包含迁移和种子的更新请求。', requestError: '无法请求服务器更新。', loadError: '无法加载更新状态。', logTitle: '更新日志', logEmpty: '暂无更新日志。', adminOnly: '只有管理员可以启动更新。', operations: { update: '标准更新', update_migrate_seed: '更新 + 迁移 + 种子' }, states: { idle: '空闲', queued: '已排队', running: '进行中', succeeded: '成功', failed: '失败' },
      }, logs: { refresh: '刷新日志' },
    },
  },
}

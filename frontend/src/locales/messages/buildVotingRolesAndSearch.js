export const buildVotingRolesAndSearchMessages = {
  en: {
    builds: {
      ...
      create: {
        shipSearch: { searchPlaceholder: 'Search ships…', noMatches: 'No matching ships.' },
        specialCrew: { searchPlaceholder: 'Search specialists…', noMatches: 'No matching specialists.' },
      },
    },
    admin: { buildRoles: {
  ...
  de: {
    builds: {
      ...
      create: {
        shipSearch: { searchPlaceholder: 'Schiffe durchsuchen…', noMatches: 'Keine passenden Schiffe.' },
        specialCrew: { searchPlaceholder: 'Specialists durchsuchen…', noMatches: 'Keine passenden Specialists.' },
      },
    },
    admin: { buildRoles: {
  ...
  fr: {
    builds: { voting: { upvotes: 'Votes', upvote: 'Voter', remove: 'Retirer le vote', error: 'Votre vote n’a pas pu être enregistré.' }, create: { shipSearch: { searchPlaceholder: 'Rechercher des navires…', noMatches: 'Aucun navire correspondant.' }, specialCrew: { searchPlaceholder: 'Rechercher des spécialistes…', noMatches: 'Aucun spécialiste correspondant.' } } },
  ...
  es: {
    builds: { voting: { upvotes: 'Votos', upvote: 'Votar', remove: 'Quitar voto', error: 'No se pudo guardar tu voto.' }, create: { shipSearch: { searchPlaceholder: 'Buscar barcos…', noMatches: 'No hay barcos coincidentes.' }, specialCrew: { searchPlaceholder: 'Buscar especialistas…', noMatches: 'No hay especialistas coincidentes.' } } },
  ...
  pt: {
    builds: { voting: { upvotes: 'Votos', upvote: 'Votar', remove: 'Remover voto', error: 'Não foi possível guardar o voto.' }, create: { shipSearch: { searchPlaceholder: 'Pesquisar navios…', noMatches: 'Nenhum navio correspondente.' }, specialCrew: { searchPlaceholder: 'Pesquisar especialistas…', noMatches: 'Nenhum especialista correspondente.' } } },
  ...
  ru: {
    builds: { voting: { upvotes: 'Голоса', upvote: 'Поддержать', remove: 'Убрать голос', error: 'Не удалось сохранить голос.' }, create: { shipSearch: { searchPlaceholder: 'Поиск кораблей…', noMatches: 'Подходящие корабли не найдены.' }, specialCrew: { searchPlaceholder: 'Поиск специалистов…', noMatches: 'Подходящие специалисты не найдены.' } } },
  ...
  cn: {
    builds: { voting: { upvotes: '赞成票', upvote: '赞成', remove: '取消投票', error: '无法保存你的投票。' }, create: { shipSearch: { searchPlaceholder: '搜索船只…', noMatches: '没有匹配的船只。' }, specialCrew: { searchPlaceholder: '搜索专家…', noMatches: '没有匹配的专家。' } } },

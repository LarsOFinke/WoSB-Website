export const buildEditingAndPreferencesMessages = {
  ...
  ru: {
    builds: {
      create: { crew: { sailorMinimum: 'Требуемый минимум матросов: {value}', workingSpeed: 'Рабочая скорость: {value}%', tooFewSailors: 'Назначено {current} из {minimum} требуемых матросов.' }, saveReadiness: { blockedTitle: 'Билд пока нельзя сохранить', blockedHint: 'Исправьте следующие требования.', readyTitle: 'Билд готов к сохранению', readyHint: 'Все требования выполнены.', reasons: { name: 'Введите название.', ship: 'Выберите корабль.', sailors: 'Назначьте не менее {minimum} матросов (сейчас {current}).', crew: 'Экипаж {current} превышает вместимость {maximum}.', upgrade5: 'Слот 5 заблокирован.', upgrade6: 'Для слота 6 нужна Structural Expansion или два источника по одному слоту.', upgrade7: 'Для слота 7 нужна Structural Expansion и награда исследования либо дополнительный слот корабля.', upgrade8: 'Для слота 8 нужны Structural Expansion, награда исследования и дополнительный слот корабля.', weapons: 'Оружие несовместимо или превышает вместимость.', specialists: 'Выберите не более {maximum} разных специалистов.' } } },

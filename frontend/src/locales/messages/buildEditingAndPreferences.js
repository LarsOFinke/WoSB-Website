export const buildEditingAndPreferencesMessages = {
  ...
  ru: {
    builds: {
      create: { crew: { sailorMinimum: 'Требуемый минимум матросов: {value}', workingSpeed: 'Рабочая скорость: {value}%', tooFewSailors: 'Назначено {current} из {minimum} требуемых матросов.' }, saveReadiness: { blockedTitle: 'Билд пока нельзя сохранить', blockedHint: 'Исправьте следующие требования.', readyTitle: 'Билд готов к сохранению', readyHint: 'Все требования выполнены.', reasons: { name: 'Введите название.', ship: 'Выберите корабль.', sailors: 'Назначьте не менее {minimum} матросов (сейчас {current}).', crew: 'Экипаж {current} превышает вместимость {maximum}.', upgrade5: 'Слот 5 заблокирован.', upgrade6: 'Слот 6 недоступен.', weapons: 'Оружие несовместимо или превышает вместимость.', specialists: 'Выберите не более {maximum} разных специалистов.' } } },

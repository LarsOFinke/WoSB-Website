export const baseMessages = {
  en: {
    ...
    home: {
      ...
      about: 'Blackwater Mercenaries Hub brings focused tools into one place so players can prepare builds and later coordinate groups without digging through scattered notes.',
  ...
  de: {
    ...
    home: {
      ...
      about: 'Der Blackwater Mercenaries Hub bündelt nützliche Werkzeuge an einem Ort, damit Spieler Builds vorbereiten und später einfacher zusammenfinden können.',
  ...
  fr: {
    ...
    home: {
      ...
      about: 'Blackwater Mercenaries Hub rassemble des outils utiles en un seul endroit pour préparer des builds et, plus tard, coordonner des groupes plus facilement.',
  ...
  es: {
    ...
    home: {
      ...
      about: 'Blackwater Mercenaries Hub reúne herramientas útiles en un solo lugar para preparar builds y, más adelante, coordinar grupos con menos fricción.',
  ...
  pt: {
    ...
    home: {
      ...
      about: 'O Blackwater Mercenaries Hub reúne ferramentas úteis em um só lugar para preparar builds e, mais tarde, coordenar grupos com menos atrito.',
  ...
  ru: {
    ...
    home: {
      ...
      about: 'Blackwater Mercenaries Hub собирает полезные инструменты в одном месте: сначала для билдов, позже для групп и других задач сообщества.',
  ...
  cn: {
    ...
    home: {
      ...
      about: 'Blackwater Mercenaries Hub 将实用工具集中在一个地方：先支持 Build Manager，之后再扩展队伍、资料和舰队工具。',

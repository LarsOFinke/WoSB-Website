export const baseMessages = {
  en: {
    ...
    home: {
      ...
      about: 'Royal Blackwater Vanguards brings focused tools into one place so players can prepare builds and later coordinate groups without digging through scattered notes.',
  ...
  de: {
    ...
    home: {
      ...
      about: 'Die Royal Blackwater Vanguards bündeln nützliche Werkzeuge an einem Ort, damit Spieler Builds vorbereiten und später einfacher zusammenfinden können.',
  ...
  fr: {
    ...
    home: {
      ...
      about: 'Royal Blackwater Vanguards rassemble des outils utiles en un seul endroit pour préparer des builds et, plus tard, coordonner des groupes plus facilement.',
  ...
  es: {
    ...
    home: {
      ...
      about: 'Royal Blackwater Vanguards reúne herramientas útiles en un solo lugar para preparar builds y, más adelante, coordinar grupos con menos fricción.',
  ...
  pt: {
    ...
    home: {
      ...
      about: 'O Royal Blackwater Vanguards reúne ferramentas úteis em um só lugar para preparar builds e, mais tarde, coordenar grupos com menos atrito.',
  ...
  ru: {
    ...
    home: {
      ...
      about: 'Royal Blackwater Vanguards собирает полезные инструменты в одном месте: сначала для билдов, позже для групп и других задач сообщества.',
  ...
  cn: {
    ...
    home: {
      ...
      about: 'Royal Blackwater Vanguards 将实用工具集中在一个地方：先支持 Build Manager，之后再扩展队伍、资料和舰队工具。',

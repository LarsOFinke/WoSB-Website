export const securityAuditDashboardMessages = {
  en: {
    admin: {
      ...
      logs: {
        ...
        requestFilters: 'Request details', requestFiltersHint: 'Refine the current security scope by level, path and result ordering.',
        resultsTitle: 'Filtered system logs', resultsHint: 'Request history for the selected date, threat level and IP scope.', activeScope: 'Active scope',
      },
      security: {
        ...
        filtersTitle: 'Security scope', filtersHint: 'Combine date range, threat level and IP in one filter context. The dashboard and raw logs stay synchronized.',
        quickRange: 'Quick range', today: 'Today', sevenDays: '7 days', thirtyDays: '30 days', threatFilter: 'Threat level', allThreats: 'All threat levels', ipFilter: 'IP focus', resetFilters: 'Reset filters', activeFilters: '{count} active filters',
        filteredView: 'Filtered view', matchingIps: 'Matching IPs', clickDayHint: 'Select a day to narrow the entire log view to that date.', topMatches: 'Top matching IPs', chooseIpHint: 'Select an IP for its detailed threat profile.', noMatches: 'No IPs match the selected filters.',
  ...
  de: {
    admin: {
      ...
      logs: {
        ...
        requestFilters: 'Request-Details', requestFiltersHint: 'Den aktuellen Security-Bereich zusätzlich nach Level, Pfad und Sortierung verfeinern.',
        resultsTitle: 'Gefilterte System-Logs', resultsHint: 'Request-Historie für den gewählten Zeitraum, das Threat-Level und die IP-Auswahl.', activeScope: 'Aktiver Filterbereich',
      },
      security: {
        ...
        filtersTitle: 'Security-Filter', filtersHint: 'Zeitraum, Threat-Level und IP werden in einem gemeinsamen Filterkontext kombiniert. Dashboard und Rohlogs bleiben synchron.',
        quickRange: 'Schnellzeitraum', today: 'Heute', sevenDays: '7 Tage', thirtyDays: '30 Tage', threatFilter: 'Threat-Level', allThreats: 'Alle Threat-Level', ipFilter: 'IP-Fokus', resetFilters: 'Filter zurücksetzen', activeFilters: '{count} aktive Filter',
        filteredView: 'Gefilterte Ansicht', matchingIps: 'Passende IPs', clickDayHint: 'Einen Tag auswählen, um die gesamte Log-Ansicht auf dieses Datum einzugrenzen.', topMatches: 'Auffälligste passende IPs', chooseIpHint: 'Eine IP auswählen, um ihr Threat-Profil zu öffnen.', noMatches: 'Keine IP passt zu den gewählten Filtern.',
  ...
  fr: {
    admin: {
      ...
      logs: { sortDate: 'Trier par date', sortIp: 'Trier par IP', sortStatus: 'Trier par statut', sortDuration: 'Trier par durée', sortLevel: 'Trier par niveau', desc: 'Décroissant', asc: 'Croissant', requestFilters: 'Détails des requêtes', requestFiltersHint: 'Affiner la portée de sécurité par niveau, chemin et ordre.', resultsTitle: 'Journaux filtrés', resultsHint: 'Historique pour la période, le niveau de menace et l’IP sélectionnés.', activeScope: 'Portée active' },
      security: { title: 'Surveillance de sécurité', subtitle: 'Tendances quotidiennes et niveau de menace des IP à partir des journaux.', from: 'Du', to: 'Au', sort: 'Tri des IP', sortThreat: 'Menace la plus élevée', sortRequests: 'Plus de requêtes', sortRecent: 'Plus récent', sortIp: 'Adresse IP', selectedIp: 'IP ciblée', allIps: 'Toutes les IP', currentThreat: 'Niveau de menace actuel', requests: 'Requêtes', uniqueIps: 'IP uniques', suspicious: 'Détections suspectes', loading: 'Chargement du tableau de sécurité ...', loadError: 'Impossible de charger le tableau de sécurité.', byDay: 'Activité par jour', byIp: 'Aperçu des menaces IP', day: 'Jour', paths: 'chemins', lastSeen: 'Dernière activité', noIps: 'Aucune activité IP sur cette période.', methodNote: 'Les scores sont des indicateurs de suivi basés sur les erreurs, réponses 4xx/5xx, chemins de scan et schémas de requêtes. Ils ne bloquent pas automatiquement.', filtersTitle: 'Périmètre de sécurité', filtersHint: 'Combinez période, menace et IP dans un même contexte.', quickRange: 'Période rapide', today: 'Aujourd’hui', sevenDays: '7 jours', thirtyDays: '30 jours', threatFilter: 'Niveau de menace', allThreats: 'Toutes les menaces', ipFilter: 'IP ciblée', resetFilters: 'Réinitialiser', activeFilters: '{count} filtres actifs', filteredView: 'Vue filtrée', matchingIps: 'IP correspondantes', clickDayHint: 'Sélectionnez un jour pour filtrer toute la vue.', topMatches: 'Principales IP', chooseIpHint: 'Sélectionnez une IP pour voir son profil.', noMatches: 'Aucune IP ne correspond.', levels: { low: 'Faible', guarded: 'Surveillé', elevated: 'Élevé', critical: 'Critique' } },
  ...
  es: {
    admin: {
      ...
      logs: { sortDate: 'Ordenar por fecha', sortIp: 'Ordenar por IP', sortStatus: 'Ordenar por estado', sortDuration: 'Ordenar por duración', sortLevel: 'Ordenar por nivel', desc: 'Descendente', asc: 'Ascendente', requestFilters: 'Detalles de solicitudes', requestFiltersHint: 'Refina el alcance por nivel, ruta y orden.', resultsTitle: 'Logs filtrados', resultsHint: 'Historial para el periodo, amenaza e IP seleccionados.', activeScope: 'Alcance activo' },
      security: { title: 'Monitorización de seguridad', subtitle: 'Patrones diarios y nivel de amenaza de IP según los registros guardados.', from: 'Desde', to: 'Hasta', sort: 'Orden de IP', sortThreat: 'Mayor amenaza', sortRequests: 'Más solicitudes', sortRecent: 'Más reciente', sortIp: 'Dirección IP', selectedIp: 'IP enfocada', allIps: 'Todas las IP', currentThreat: 'Nivel de amenaza actual', requests: 'Solicitudes', uniqueIps: 'IP únicas', suspicious: 'Detecciones sospechosas', loading: 'Cargando panel de seguridad ...', loadError: 'No se pudo cargar el panel de seguridad.', byDay: 'Actividad por día', byIp: 'Resumen de amenaza por IP', day: 'Día', paths: 'rutas', lastSeen: 'Última actividad', noIps: 'Sin actividad IP en este periodo.', methodNote: 'Las puntuaciones son indicadores basados en errores, respuestas 4xx/5xx, rutas de escaneo y patrones de solicitudes. No bloquean automáticamente.', filtersTitle: 'Ámbito de seguridad', filtersHint: 'Combina fechas, amenaza e IP en un solo contexto.', quickRange: 'Periodo rápido', today: 'Hoy', sevenDays: '7 días', thirtyDays: '30 días', threatFilter: 'Nivel de amenaza', allThreats: 'Todas las amenazas', ipFilter: 'IP enfocada', resetFilters: 'Restablecer', activeFilters: '{count} filtros activos', filteredView: 'Vista filtrada', matchingIps: 'IP coincidentes', clickDayHint: 'Selecciona un día para filtrar toda la vista.', topMatches: 'IP principales', chooseIpHint: 'Selecciona una IP para ver su perfil.', noMatches: 'Ninguna IP coincide.', levels: { low: 'Bajo', guarded: 'Vigilado', elevated: 'Elevado', critical: 'Crítico' } },
  ...
  pt: {
    admin: {
      ...
      logs: { sortDate: 'Ordenar por data', sortIp: 'Ordenar por IP', sortStatus: 'Ordenar por estado', sortDuration: 'Ordenar por duração', sortLevel: 'Ordenar por nível', desc: 'Descendente', asc: 'Ascendente', requestFilters: 'Detalhes dos pedidos', requestFiltersHint: 'Refine o âmbito por nível, caminho e ordenação.', resultsTitle: 'Logs filtrados', resultsHint: 'Histórico para período, ameaça e IP selecionados.', activeScope: 'Âmbito ativo' },
      security: { title: 'Monitorização de segurança', subtitle: 'Padrões diários e nível de ameaça de IP com base nos logs guardados.', from: 'De', to: 'Até', sort: 'Ordenação de IP', sortThreat: 'Maior ameaça', sortRequests: 'Mais pedidos', sortRecent: 'Mais recente', sortIp: 'Endereço IP', selectedIp: 'IP em foco', allIps: 'Todos os IPs', currentThreat: 'Nível de ameaça atual', requests: 'Pedidos', uniqueIps: 'IPs únicos', suspicious: 'Ocorrências suspeitas', loading: 'A carregar painel de segurança ...', loadError: 'Não foi possível carregar o painel de segurança.', byDay: 'Atividade por dia', byIp: 'Visão de ameaça por IP', day: 'Dia', paths: 'caminhos', lastSeen: 'Última atividade', noIps: 'Sem atividade IP neste período.', methodNote: 'As pontuações são indicadores baseados em erros, respostas 4xx/5xx, caminhos de scan e padrões de pedidos. Não bloqueiam automaticamente.', filtersTitle: 'Âmbito de segurança', filtersHint: 'Combine período, ameaça e IP num único contexto.', quickRange: 'Período rápido', today: 'Hoje', sevenDays: '7 dias', thirtyDays: '30 dias', threatFilter: 'Nível de ameaça', allThreats: 'Todas as ameaças', ipFilter: 'IP em foco', resetFilters: 'Repor filtros', activeFilters: '{count} filtros ativos', filteredView: 'Vista filtrada', matchingIps: 'IPs correspondentes', clickDayHint: 'Selecione um dia para filtrar toda a vista.', topMatches: 'Principais IPs', chooseIpHint: 'Selecione um IP para ver o perfil.', noMatches: 'Nenhum IP corresponde.', levels: { low: 'Baixo', guarded: 'Vigiado', elevated: 'Elevado', critical: 'Crítico' } },
  ...
  ru: {
    admin: {
      ...
      logs: { sortDate: 'Сортировать по дате', sortIp: 'Сортировать по IP', sortStatus: 'Сортировать по статусу', sortDuration: 'Сортировать по длительности', sortLevel: 'Сортировать по уровню', desc: 'По убыванию', asc: 'По возрастанию', requestFilters: 'Детали запросов', requestFiltersHint: 'Уточните область по уровню, пути и сортировке.', resultsTitle: 'Отфильтрованные логи', resultsHint: 'История для выбранных периода, угрозы и IP.', activeScope: 'Активная область' },
      security: { title: 'Мониторинг безопасности', subtitle: 'Дневные шаблоны запросов и оценка угроз IP по сохранённым логам.', from: 'С', to: 'По', sort: 'Сортировка IP', sortThreat: 'Наивысшая угроза', sortRequests: 'Больше запросов', sortRecent: 'Последняя активность', sortIp: 'IP-адрес', selectedIp: 'Выбранный IP', allIps: 'Все IP', currentThreat: 'Текущий уровень угрозы', requests: 'Запросы', uniqueIps: 'Уникальные IP', suspicious: 'Подозрительные события', loading: 'Загрузка панели безопасности ...', loadError: 'Не удалось загрузить панель безопасности.', byDay: 'Активность по дням', byIp: 'Обзор угроз по IP', day: 'День', paths: 'пути', lastSeen: 'Последняя активность', noIps: 'Нет IP-активности за этот период.', methodNote: 'Оценки — индикаторы мониторинга по ошибкам, ответам 4xx/5xx, путям сканирования и шаблонам запросов. Они не блокируют IP автоматически.', filtersTitle: 'Область безопасности', filtersHint: 'Объедините период, угрозу и IP в одном контексте.', quickRange: 'Быстрый период', today: 'Сегодня', sevenDays: '7 дней', thirtyDays: '30 дней', threatFilter: 'Уровень угрозы', allThreats: 'Все угрозы', ipFilter: 'Выбранный IP', resetFilters: 'Сбросить', activeFilters: 'Активных фильтров: {count}', filteredView: 'Отфильтровано', matchingIps: 'Подходящие IP', clickDayHint: 'Выберите день для фильтрации всей страницы.', topMatches: 'Главные IP', chooseIpHint: 'Выберите IP для просмотра профиля.', noMatches: 'Нет подходящих IP.', levels: { low: 'Низкий', guarded: 'Наблюдение', elevated: 'Повышенный', critical: 'Критический' } },
  ...
  cn: {
    admin: {
      tabs: { audit: '审计历史' },
      logs: { sortDate: '按日期排序', sortIp: '按 IP 排序', sortStatus: '按状态排序', sortDuration: '按耗时排序', sortLevel: '按级别排序', desc: '降序', asc: '升序', requestFilters: '请求详情', requestFiltersHint: '按级别、路径和排序进一步筛选。', resultsTitle: '已筛选系统日志', resultsHint: '所选日期、威胁等级和 IP 范围内的请求历史。', activeScope: '当前范围' },
      security: { title: '安全监控', subtitle: '基于已保存系统日志的每日请求趋势和 IP 威胁评分。', from: '开始', to: '结束', sort: 'IP 排序', sortThreat: '最高威胁', sortRequests: '最多请求', sortRecent: '最近活动', sortIp: 'IP 地址', selectedIp: '聚焦 IP', allIps: '全部 IP', currentThreat: '当前威胁等级', requests: '请求', uniqueIps: '唯一 IP', suspicious: '可疑命中', loading: '正在加载安全面板 ...', loadError: '无法加载安全面板。', byDay: '按天活动', byIp: 'IP 威胁概览', day: '日期', paths: '路径', lastSeen: '最后出现', noIps: '此期间没有 IP 活动。', methodNote: '威胁分数是根据错误、4xx/5xx、可疑扫描路径和请求模式得出的监控指标，不会自动封禁。', filtersTitle: '安全范围', filtersHint: '在同一上下文中组合日期、威胁等级和 IP。', quickRange: '快捷时间', today: '今天', sevenDays: '7 天', thirtyDays: '30 天', threatFilter: '威胁等级', allThreats: '全部威胁', ipFilter: '聚焦 IP', resetFilters: '重置筛选', activeFilters: '{count} 个筛选条件', filteredView: '筛选视图', matchingIps: '匹配 IP', clickDayHint: '选择日期以筛选整个日志视图。', topMatches: '主要匹配 IP', chooseIpHint: '选择 IP 查看威胁详情。', noMatches: '没有匹配的 IP。', levels: { low: '低', guarded: '关注', elevated: '升高', critical: '严重' } },

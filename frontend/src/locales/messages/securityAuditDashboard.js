export const securityAuditDashboardMessages = {
  en: {
    admin: {
      ...
      security: {
        ...
        from: 'From', to: 'To', sort: 'IP sorting', sortThreat: 'Highest threat', sortRequests: 'Most requests', sortRecent: 'Most recent', sortIp: 'IP address',
  ...
  de: {
    admin: {
      ...
      security: {
        ...
        from: 'Von', to: 'Bis', sort: 'IP-Sortierung', sortThreat: 'Höchste Bedrohung', sortRequests: 'Meiste Requests', sortRecent: 'Zuletzt aktiv', sortIp: 'IP-Adresse',
  ...
  es: {
    admin: {
      ...
      security: { title: 'Monitorización de seguridad', subtitle: 'Patrones diarios y nivel de amenaza de IP según los registros guardados.', from: 'Desde', to: 'Hasta', sort: 'Orden de IP', sortThreat: 'Mayor amenaza', sortRequests: 'Más solicitudes', sortRecent: 'Más reciente', sortIp: 'Dirección IP', currentThreat: 'Nivel de amenaza actual', requests: 'Solicitudes', uniqueIps: 'IP únicas', suspicious: 'Detecciones sospechosas', loading: 'Cargando panel de seguridad ...', loadError: 'No se pudo cargar el panel de seguridad.', byDay: 'Actividad por día', byIp: 'Resumen de amenaza por IP', day: 'Día', paths: 'rutas', lastSeen: 'Última actividad', noIps: 'Sin actividad IP en este periodo.', methodNote: 'Las puntuaciones son indicadores basados en errores, respuestas 4xx/5xx, rutas de escaneo y patrones de solicitudes. No bloquean automáticamente.', levels: { low: 'Bajo', guarded: 'Vigilado', elevated: 'Elevado', critical: 'Crítico' } },
  ...
  pt: {
    admin: {
      ...
      security: { title: 'Monitorização de segurança', subtitle: 'Padrões diários e nível de ameaça de IP com base nos logs guardados.', from: 'De', to: 'Até', sort: 'Ordenação de IP', sortThreat: 'Maior ameaça', sortRequests: 'Mais pedidos', sortRecent: 'Mais recente', sortIp: 'Endereço IP', currentThreat: 'Nível de ameaça atual', requests: 'Pedidos', uniqueIps: 'IPs únicos', suspicious: 'Ocorrências suspeitas', loading: 'A carregar painel de segurança ...', loadError: 'Não foi possível carregar o painel de segurança.', byDay: 'Atividade por dia', byIp: 'Visão de ameaça por IP', day: 'Dia', paths: 'caminhos', lastSeen: 'Última atividade', noIps: 'Sem atividade IP neste período.', methodNote: 'As pontuações são indicadores baseados em erros, respostas 4xx/5xx, caminhos de scan e padrões de pedidos. Não bloqueiam automaticamente.', levels: { low: 'Baixo', guarded: 'Vigiado', elevated: 'Elevado', critical: 'Crítico' } },
  ...
  ru: {
    admin: {
      ...
      security: { title: 'Мониторинг безопасности', subtitle: 'Дневные шаблоны запросов и оценка угроз IP по сохранённым логам.', from: 'С', to: 'По', sort: 'Сортировка IP', sortThreat: 'Наивысшая угроза', sortRequests: 'Больше запросов', sortRecent: 'Последняя активность', sortIp: 'IP-адрес', currentThreat: 'Текущий уровень угрозы', requests: 'Запросы', uniqueIps: 'Уникальные IP', suspicious: 'Подозрительные события', loading: 'Загрузка панели безопасности ...', loadError: 'Не удалось загрузить панель безопасности.', byDay: 'Активность по дням', byIp: 'Обзор угроз по IP', day: 'День', paths: 'пути', lastSeen: 'Последняя активность', noIps: 'Нет IP-активности за этот период.', methodNote: 'Оценки — индикаторы мониторинга по ошибкам, ответам 4xx/5xx, путям сканирования и шаблонам запросов. Они не блокируют IP автоматически.', levels: { low: 'Низкий', guarded: 'Наблюдение', elevated: 'Повышенный', critical: 'Критический' } },

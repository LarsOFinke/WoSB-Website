export const neutralValues = new Set([
  ...
  'Impressum', 'Forum', 'Guides', 'Admin', 'PvE', 'PvP', 'Support', 'Builds', 'Hold', 'Lanterns', 'Sails', 'Sources', 'Fleet', 'Profiles', 'Weapons',
])
...
export const exactTranslations = {
  de: {
    'Inline media tools': 'Inline-Medienwerkzeuge',
    'Insert uploaded files at the current cursor position and choose a display size.': 'Füge hochgeladene Dateien an der aktuellen Cursorposition ein und wähle eine Anzeigegröße.',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': 'Lade zuerst Dateien hoch und platziere sie danach mit den Inline-Medienwerkzeugen im Text. Ungenutzte Dateien bleiben normale Anhänge.',
    'Insert here': 'Hier einfügen',
    'Remove attachment': 'Anhang entfernen',
    'Content preview': 'Inhaltsvorschau',
    'File #{id} is not attached to this content.': 'Datei #{id} ist diesem Inhalt nicht angehängt.',
    'Small': 'Klein',
    'Medium': 'Mittel',
    'Large': 'Groß',
    'Full width': 'Volle Breite',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': 'Bilder bis 12 MB, Dokumente bis 20 MB, Videos bis 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF oder TXT',
    '{name}: unsupported file type.': '{name}: Dateityp wird nicht unterstützt.',
    '{name}: empty files cannot be uploaded.': '{name}: Leere Dateien können nicht hochgeladen werden.',
    '{name}: file is too large. Limit: {limit}.': '{name}: Datei ist zu groß. Limit: {limit}.',
    'Primary': 'Primär',
    'Account': 'Account',
    'Staff quick actions': 'Team-Schnellaktionen',
  },
  fr: {
    'Server provisioned': 'Serveur provisionné',
    'Response validated': 'Réponse validée',
    'Connection verified': 'Connexion vérifiée',
    'Request ready': 'Demande prête',
    'Advanced fallback: paste RESPONSE.json manually': 'Solution de secours avancée : coller RESPONSE.json manuellement',
    'Advanced manual setup': 'Configuration manuelle avancée',
    'Selected file: {filename}': 'Fichier sélectionné : {filename}',
    'The selected response is not valid JSON.': 'La réponse sélectionnée n’est pas un JSON valide.',
    'The response file could not be read.': 'Le fichier de réponse n’a pas pu être lu.',
    'Inline media tools': 'Outils média intégrés',
    'Insert uploaded files at the current cursor position and choose a display size.': 'Insérez les fichiers téléversés à la position actuelle du curseur et choisissez une taille d’affichage.',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': 'Téléversez d’abord les fichiers, puis placez-les dans le texte avec les outils média intégrés. Les fichiers non utilisés restent des pièces jointes classiques.',
    'Insert here': 'Insérer ici',
    'Remove attachment': 'Retirer la pièce jointe',
    'Content preview': 'Aperçu du contenu',
    'File #{id} is not attached to this content.': 'Le fichier #{id} n’est pas joint à ce contenu.',
    'Small': 'Petit',
    'Medium': 'Moyen',
    'Large': 'Grand',
    'Full width': 'Pleine largeur',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': 'Images jusqu’à 12 Mo, documents jusqu’à 20 Mo, vidéos jusqu’à 80 Mo · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF ou TXT',
    '{name}: unsupported file type.': '{name} : type de fichier non pris en charge.',
    '{name}: empty files cannot be uploaded.': '{name} : les fichiers vides ne peuvent pas être téléversés.',
    '{name}: file is too large. Limit: {limit}.': '{name} : fichier trop volumineux. Limite : {limit}.',
    'Primary': 'Principal',
    'Account': 'Compte',
  ...
  es: {
    'Server provisioned': 'Servidor aprovisionado',
    'Response validated': 'Respuesta validada',
    'Connection verified': 'Conexión verificada',
    'Request ready': 'Solicitud lista',
    'Advanced fallback: paste RESPONSE.json manually': 'Alternativa avanzada: pegar RESPONSE.json manualmente',
    'Advanced manual setup': 'Configuración manual avanzada',
    'Selected file: {filename}': 'Archivo seleccionado: {filename}',
    'The selected response is not valid JSON.': 'La respuesta seleccionada no es un JSON válido.',
    'The response file could not be read.': 'No se pudo leer el archivo de respuesta.',
    'Inline media tools': 'Herramientas de medios en línea',
    'Insert uploaded files at the current cursor position and choose a display size.': 'Inserta los archivos subidos en la posición actual del cursor y elige un tamaño de visualización.',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': 'Sube primero los archivos y colócalos después en el texto con las herramientas de medios en línea. Los archivos sin usar quedan como adjuntos normales.',
    'Insert here': 'Insertar aquí',
    'Remove attachment': 'Quitar adjunto',
    'Content preview': 'Vista previa del contenido',
    'File #{id} is not attached to this content.': 'El archivo #{id} no está adjunto a este contenido.',
    'Small': 'Pequeño',
    'Medium': 'Mediano',
    'Large': 'Grande',
    'Full width': 'Ancho completo',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': 'Imágenes hasta 12 MB, documentos hasta 20 MB, vídeos hasta 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF o TXT',
    '{name}: unsupported file type.': '{name}: tipo de archivo no compatible.',
    '{name}: empty files cannot be uploaded.': '{name}: no se pueden subir archivos vacíos.',
    '{name}: file is too large. Limit: {limit}.': '{name}: el archivo es demasiado grande. Límite: {limit}.',
    'Primary': 'Principal',
    'Account': 'Cuenta',
  ...
  pt: {
    'Server provisioned': 'Servidor provisionado',
    'Response validated': 'Resposta validada',
    'Connection verified': 'Ligação verificada',
    'Request ready': 'Pedido pronto',
    'Advanced fallback: paste RESPONSE.json manually': 'Alternativa avançada: colar RESPONSE.json manualmente',
    'Advanced manual setup': 'Configuração manual avançada',
    'Selected file: {filename}': 'Ficheiro selecionado: {filename}',
    'The selected response is not valid JSON.': 'A resposta selecionada não é um JSON válido.',
    'The response file could not be read.': 'Não foi possível ler o ficheiro de resposta.',
    'Inline media tools': 'Ferramentas de multimédia inline',
    'Insert uploaded files at the current cursor position and choose a display size.': 'Insira os ficheiros carregados na posição atual do cursor e escolha um tamanho de apresentação.',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': 'Carregue primeiro os ficheiros e coloque-os depois no texto com as ferramentas de multimédia inline. Os ficheiros não usados ficam como anexos normais.',
    'Insert here': 'Inserir aqui',
    'Remove attachment': 'Remover anexo',
    'Content preview': 'Pré-visualização do conteúdo',
    'File #{id} is not attached to this content.': 'O ficheiro #{id} não está anexado a este conteúdo.',
    'Small': 'Pequeno',
    'Medium': 'Médio',
    'Large': 'Grande',
    'Full width': 'Largura total',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': 'Imagens até 12 MB, documentos até 20 MB, vídeos até 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF ou TXT',
    '{name}: unsupported file type.': '{name}: tipo de ficheiro não suportado.',
    '{name}: empty files cannot be uploaded.': '{name}: ficheiros vazios não podem ser carregados.',
    '{name}: file is too large. Limit: {limit}.': '{name}: o ficheiro é demasiado grande. Limite: {limit}.',
    'Primary': 'Principal',
    'Account': 'Conta',
  ...
  ru: {
    ...
    'Response validated': 'Ответ проверен',
    'Connection verified': 'Подключение проверено',
    'Request ready': 'Запрос готов',
    'Advanced fallback: paste RESPONSE.json manually': 'Расширенный резервный вариант: вставить RESPONSE.json вручную',
    'Advanced manual setup': 'Расширенная ручная настройка',
    'Selected file: {filename}': 'Выбранный файл: {filename}',
    'The selected response is not valid JSON.': 'Выбранный ответ не является допустимым JSON.',
    'The response file could not be read.': 'Не удалось прочитать файл ответа.',
    'Inline media tools': 'Инструменты встроенных медиа',
    'Insert uploaded files at the current cursor position and choose a display size.': 'Вставьте загруженные файлы в текущую позицию курсора и выберите размер отображения.',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': 'Сначала загрузите файлы, затем разместите их в тексте с помощью инструментов встроенных медиа. Неиспользованные файлы останутся обычными вложениями.',
    'Insert here': 'Вставить сюда',
    'Remove attachment': 'Удалить вложение',
    'Content preview': 'Предпросмотр контента',
    'File #{id} is not attached to this content.': 'Файл #{id} не прикреплен к этому контенту.',
    'Small': 'Малый',
    'Medium': 'Средний',
    'Large': 'Большой',
    'Full width': 'На всю ширину',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': 'Изображения до 12 МБ, документы до 20 МБ, видео до 80 МБ · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF или TXT',
    '{name}: unsupported file type.': '{name}: тип файла не поддерживается.',
    '{name}: empty files cannot be uploaded.': '{name}: пустые файлы нельзя загрузить.',
    '{name}: file is too large. Limit: {limit}.': '{name}: файл слишком большой. Лимит: {limit}.',
    'Primary': 'Основное',
    'Account': 'Аккаунт',
  ...
  cn: {
    ...
    'Response validated': '响应已验证',
    'Connection verified': '连接已验证',
    'Request ready': '请求已就绪',
    'Advanced fallback: paste RESPONSE.json manually': '高级备用方式：手动粘贴 RESPONSE.json',
    'Advanced manual setup': '高级手动设置',
    'Selected file: {filename}': '已选择文件：{filename}',
    'The selected response is not valid JSON.': '所选响应不是有效的 JSON。',
    'The response file could not be read.': '无法读取响应文件。',
    'Inline media tools': '内嵌媒体工具',
    'Insert uploaded files at the current cursor position and choose a display size.': '将已上传文件插入到当前光标位置，并选择显示尺寸。',
    'Upload files first, then place them in the text with the inline media tools. You can keep unused files as regular attachments.': '先上传文件，再用内嵌媒体工具把它们放到正文中。未使用的文件会作为普通附件保留。',
    'Insert here': '插入到此处',
    'Remove attachment': '移除附件',
    'Content preview': '内容预览',
    'File #{id} is not attached to this content.': '文件 #{id} 未附加到此内容。',
    'Small': '小',
    'Medium': '中',
    'Large': '大',
    'Full width': '全宽',
    'Images up to 12 MB, documents up to 20 MB, videos up to 80 MB · GIF, MP4, JPEG, PNG, WebP, WebM, MOV, PDF or TXT': '图片最大 12 MB，文档最大 20 MB，视频最大 80 MB · GIF、MP4、JPEG、PNG、WebP、WebM、MOV、PDF 或 TXT',
    '{name}: unsupported file type.': '{name}: 不支持的文件类型。',
    '{name}: empty files cannot be uploaded.': '{name}: 不能上传空文件。',
    '{name}: file is too large. Limit: {limit}.': '{name}: 文件过大。限制：{limit}。',
    'Primary': '主要',
    'Account': '账户',
...
export const generatedPhraseTranslations = {
  ...
  fr: {
    '{count} specialists': '{count} spécialistes',
    'Specialists: {items}': 'Spécialistes : {items}',
    '{value} specialists': '{value} spécialistes',
    'Specialists': 'Spécialistes',
    'Specialist slot {index}': 'Emplacement spécialiste {index}',
  ...
  es: {
    '{count} specialists': '{count} especialistas',
    'Specialists: {items}': 'Especialistas: {items}',
    '{value} specialists': '{value} especialistas',
    'Specialists': 'Especialistas',
    'Specialist slot {index}': 'Espacio de especialista {index}',
  ...
  pt: {
    ...
    '{value} specialists': '{value} especialistas',
    'Specialists': 'Especialistas',
    'Specialist slot {index}': 'Espaço de especialista {index}',
  ...
  ru: {
    '{count} specialists': '{count} специалистов',
    'Specialists: {items}': 'Специалисты: {items}',
    '{value} specialists': '{value} специалистов',
    'Specialists': 'Специалисты',
    'Specialist slot {index}': 'Слот специалиста {index}',
    'Who we are': 'Кто мы',
    'Today': 'Сегодня',
    'Month': 'Месяц',
  ...
  cn: {
    '{count} specialists': '{count} 名专家',
    'Specialists: {items}': '专家：{items}',
    '{value} specialists': '{value} 名专家',
    'Specialists': '专家',
    'Specialist slot {index}': '专家槽位 {index}',
    'Who we are': '关于我们',
    'Today': '今天',
    'Month': '月份',
    'Selected day': '选中日期',

...
function slotSummary(build) {
  ...
  const used = stats.upgrade_slots_used ?? [build.upgrade_1, build.upgrade_2, build.upgrade_3, build.upgrade_4, build.upgrade_5, build.upgrade_6, build.upgrade_7, build.upgrade_8].filter(Boolean).length

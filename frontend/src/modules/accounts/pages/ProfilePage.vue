...
const {
  t, setSessionUser, loading, saving, changingPassword,
  error, success, passwordError, passwordSuccess, fleetMemberships,
  preferenceOptions, activeFleetMemberships, leadershipMemberships, primaryFleetMembership, hasOfficialFleetLink,
  ...
  fillForm, loadMemberships, loadProfile, saveProfile, submitPasswordChange,
} = useProfilePage()
</script>

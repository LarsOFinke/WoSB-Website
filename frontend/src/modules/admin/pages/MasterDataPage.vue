...
.catalog-tab:hover { color: var(--text); background: var(--surface-highlight); }
.catalog-tab.is-active { color: var(--accent-strong); border-color: rgba(241,184,91,.34); background: linear-gradient(135deg, rgba(241,184,91,.15), var(--surface-soft)); box-shadow: inset 0 1px 0 rgba(255,255,255,.05); }
...
.catalog-panel-header { border-bottom: 1px solid var(--line); background: var(--surface-faint); }
.catalog-panel-header h2, .editor-header h2 { margin: .08rem 0 0; font-size: clamp(1.15rem, 1.8vw, 1.45rem); }
.panel-kicker { color: var(--accent); font-size: 0.75rem; font-weight: 900; letter-spacing: .12em; text-transform: uppercase; }
...
.catalog-record { position: relative; display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: .55rem; align-items: center; margin-bottom: .45rem; padding: .55rem; border: 1px solid transparent; border-radius: var(--radius-md); background: var(--surface-faint); }
...
.catalog-record:hover { border-color: rgba(221,231,244,.16); background: var(--surface-highlight); }
...
.status-chip { display: inline-flex; align-items: center; min-height: 1.85rem; padding: .3rem .55rem; border: 1px solid var(--line-domain); border-radius: var(--radius-pill); color: var(--muted); background: var(--surface-soft); font-size: 0.75rem; font-weight: 850; white-space: nowrap; }
.editor-panel { display: grid; gap: 0; }
.editor-header { min-height: 5.8rem; border-bottom: 1px solid var(--line); background: radial-gradient(circle at 85% 0%, rgba(241,184,91,.13), transparent 16rem), var(--surface-faint); }
.editor-header p { margin: .2rem 0 0; color: var(--muted); }
.editor-header-with-preview { justify-content: flex-start; }
.editor-preview { width: 4rem; height: 4rem; display: flex; align-items: center; justify-content: center; flex: 0 0 auto; border: 1px solid rgba(241,184,91,.34); border-radius: 1rem; color: var(--accent-strong); background: var(--accent-tint); font-size: 1.45rem; overflow: hidden; }
...
.ship-quick-stats span, .mount-summary span { display: grid; gap: .05rem; padding: .48rem .62rem; border: 1px solid var(--line-subtle); border-radius: .75rem; background: rgba(5,12,19,.38); }
.ship-quick-stats small, .mount-summary small { color: var(--muted-soft); font-size: 0.75rem; }
...
.editor-section { min-width: 0; display: grid; gap: .85rem; margin: 1rem 1rem 0; padding: 1rem; border: 1px solid var(--line-subtle); border-radius: var(--radius-md); background: rgba(5,12,19,.25); }
...
.choice-card, .toggle-field { display: flex !important; align-items: center; gap: .55rem; padding: .62rem .7rem; border: 1px solid var(--line-domain); border-radius: var(--radius-sm); background: var(--surface-faint); }
...
.mount-card { display: grid; grid-template-columns: minmax(100px, .8fr) repeat(3, minmax(85px,1fr)); gap: .55rem; align-items: end; padding: .72rem; border: 1px solid var(--line-faint); border-radius: var(--radius-sm); background: var(--surface-sheen); }
...
.override-effect-grid pre { min-height: 7.6rem; max-height: 14rem; margin: 0; padding: .75rem; overflow: auto; border: 1px solid var(--line-subtle); border-radius: var(--radius-sm); color: var(--muted); background: rgba(5,12,19,.42); font-size: .75rem; white-space: pre-wrap; }

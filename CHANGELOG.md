...
- Added normalized per-mount weapon allowances for audited ship-specific bow/stern exceptions. Azov and Deadfish now expose Zeus on their armed bow/stern mounts, while Eagle exposes Basilisk and Poseidon on its stern without broadening the general Light/Medium/Heavy mount ceiling or affecting mortars and special weapons. Migration `0009` backfills existing installations.

...
import eu.royalblackwater.api.contract.BuildItemCategoryRead;
import eu.royalblackwater.api.contract.BuildItemOptionRead;
import eu.royalblackwater.api.contract.BuildListMetrics;
...
import eu.royalblackwater.api.contract.BuildSummaryRead;
...
class BuildAssembler {
    ...
    BuildAssembler(BuildCatalogRepository catalog, BuildStatsService stats) {
        this.catalog = catalog;
        this.stats = stats;
    }

    BuildPage page(BuildPageResult result) {
    ...
    BuildRead detail(BuildAggregate aggregate) {
        return detail(aggregate, new RuntimeCache());
    }

    List<BuildRead> details(List<BuildAggregate> aggregates) {
        RuntimeCache cache = new RuntimeCache();
    ...
    BuildSummaryRead summary(BuildAggregate aggregate) {
    ...
    BuildOptionsCatalog options(Long shipId) {

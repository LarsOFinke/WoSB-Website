...
@Repository
class BuildCatalogRepository {
    private final JdbcQueryService jdbc;
    private final ShipQueryService shipQueries;

    BuildCatalogRepository(JdbcQueryService jdbc, ShipQueryService shipQueries) {
        this.jdbc = jdbc;
        this.shipQueries = shipQueries;
    }
    ...
    List<BuildCatalogOption> options(Long shipId) {
    ...
    Optional<BuildShipSnapshot> ship(long shipId) {
        ShipRead read = shipQueries.activeShip(shipId);
    ...
    Optional<BuildFeatureSnapshot> researchFeature() {
        return feature(null, true);
    }

    Optional<BuildFeatureSnapshot> feature(Long featureId) {

...
public class SystemUpdateService {
    ...
    public SystemUpdateStatus status(){
        ...
        return new SystemUpdateStatus(string(status.get("finished_at")),publicMessage(state,operation),operation,
                !requestExists&&!ACTIVE.contains(state),string(status.get("requested_at")),string(status.get("started_at")),state);
    }

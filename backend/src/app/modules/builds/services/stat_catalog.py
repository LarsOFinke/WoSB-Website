...
STAT_DEFINITIONS: tuple[StatDefinition, ...] = (
    ...
    StatDefinition("sail_deployment_speed_per_sailor_pct", "Sail deployment speed per Sailor", "mobility", unit="%", flat_effect="sail_deployment_speed_per_sailor_pct", precision=1, source="specialist_catalog"),
    StatDefinition("sail_deployment_speed_pct", "Sail deployment speed", "mobility", unit="%", flat_effect="sail_deployment_speed_pct", precision=1, source="specialist_modifiers"),

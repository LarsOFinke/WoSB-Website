...
sudo ./setup_website.sh \
  --artifact rbf-deployment-1.2.0.tar.gz \
  --checksum rbf-deployment-1.2.0.tar.gz.sha256 \
...
```bash
sudo ./update.sh --artifact /path/to/rbf-deployment-1.2.0.tar.gz
```

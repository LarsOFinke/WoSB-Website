...
sudo ./setup_website.sh \
  --artifact rbf-deployment-1.0.4.tar.gz \
  --checksum rbf-deployment-1.0.4.tar.gz.sha256 \
...
```bash
sudo ./update.sh --artifact /path/to/rbf-deployment-1.0.4.tar.gz
```

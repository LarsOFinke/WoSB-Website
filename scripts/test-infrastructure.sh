...
require_pattern 'RECOVERY_CONTRACT_FILES' "$ROOT_DIR/scripts/package_deployment_artifact.py"
...
require_pattern 'RBF_ARTIFACT_ROOT' "$INFRA_DIR/scripts/backup/recovery_report.py"
require_pattern 'RBF_ARTIFACT_ROOT' "$INFRA_DIR/scripts/backup/recovery_preflight.py"

...
| Klasse | Form | Verwenden für | Beispiel ab `1.0.5` |
| --- | --- | --- | --- |
| Patch | `x.y.Z` | Hotfixes, Fehler-, Sicherheits- und Dokumentationskorrekturen sowie kompatible interne Verbesserungen | `1.0.6` |
